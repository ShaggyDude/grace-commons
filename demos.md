...
## Beacon — one spec, three renders

The Beacon Clinical Research Portal is rendered three ways from the *same* Grace Commons specs — same compositions, same action codes, same hash-chain contract. Only the stack changes:
