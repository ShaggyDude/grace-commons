...
const Tile: FC<{ href: string; title: string; desc: string }> = ({ href, title, desc }) => (
  <a href={href} class="raised rounded-lg block hover:shadow-sm transition-all">
    <div class="font-semibold mb-1">{title}</div>
    <div class="text-sm opacity-50">{desc}</div>
  </a>
);
