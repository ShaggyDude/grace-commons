...
**Conventions inherited from the methodology.** Both regulated-pattern conventions — *Regulated adversarial scenarios* and *Generation acceptance* — are inherited from the canonical methodology in [`PRESSURE_TESTING.md`](../../PRESSURE_TESTING.md) and baked in from the first draft. Lineage notes cite the methodology directly.
