...
Architects draw plans. Composers write scores. Car designers build CAD models. *[CAD]: computer-aided design Lawyers write statutes. Software has a Git repo and hopes the README is current.
