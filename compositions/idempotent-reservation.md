...
- **[Provisional Commitment](../atoms/resource-lifecycle/provisional-commitment.md)** — provides the underlying lifecycle (Held → Confirmed | Released | Expired) and all the invariants every commitment satisfies. The application maintains exactly one Provisional Commitment instance.
