...
**Structural milestone.** This composition retires the `*(forthcoming)*` links to this composition in [`atoms/consent.md`](../atoms/consent.md)'s Composition notes and Edge cases (the *Consent withdrawal propagation* edge case names this composition as the home of the propagation Consent excludes), and this composition's composing-peer references in [`compositions/kyc-customer-onboarding.md`](./kyc-customer-onboarding.md). When this composition grounds, those forthcoming-links resolve.
...
- **[KYC / Customer Onboarding](./kyc-customer-onboarding.md)** (C8) — a composing peer. C8's processing basis is GDPR Article 6(1)(c) legal obligation; this composition governs the Article 6(1)(a) consent basis for downstream non-obligatory processing C8 does not touch. The two coexist for the same party: C8 gates AML-obligatory activity on verification; this composition gates marketing/profiling on consent.
