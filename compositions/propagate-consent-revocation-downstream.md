...
- **[Data Subject Rights Fulfillment](./data-subject-rights-fulfillment.md)** (C7) — answers DSAR access and erasure requests across the data estate. This composition's `read_consent_history` and `consent.revoked` propagation are primary inputs to a C7 right-of-access or right-to-erasure response; C7 orchestrates the cross-system fulfillment, this composition supplies the consent surface.
