...
**Structural milestone.** This composition retires the `Forensic Recovery (C3) *(forthcoming)*` forthcoming-links in [`atoms/soft-delete.md`](../atoms/soft-delete.md): specifically (a) the *Purge gate enforcement* Edge case entry — *"Forensic Recovery (C3) — Soft Delete + Event Log + Actor Identity + Audit Trail, providing the complete recoverable-destruction audit surface"* — and (b) the *Composition notes* entry — *"Forthcoming: Forensic Recovery (C3) — Soft Delete + Event Log + Actor Identity + Audit Trail, providing the complete recoverable-destruction audit surface."* When this composition grounds, both forthcoming-links are resolved.
