...
| 4 | Clearance gate | Foundational / refining / rhetorical findings | Opus — Angry Torvalds X2 | Close foundational gaps (blocks grounding); close refining findings in-pattern (does not block); record rhetorical findings with classification (does not block). Ground at zero foundational — the 95%-good threshold; see §"What grounded means" |
