...
- `compositions/attributed-permissions-admin.md` → `compositions/attributed-permissions-admin.als`, `compositions/attributed-permissions-admin.tla` (+ `attributed-permissions-admin.cfg` for TLC)
