...
Six atoms remain on the planned-sequence list (atom #7 Provenance grounded 2026-06-04; its entry below is retained as roadmap history). They are sequenced by how many downstream compositions they unblock.
...
Compositions are sequenced by readiness. Of the seventeen C-numbered compositions, seven are grounded (C1, C4, C5, C8, C13, C14, C16); nine are unblocked and not started (C2, C3, C6, C7, C9, C11, C15, C17 — plus C18 — and **C12, newly unblocked 2026-06-04 when Provenance grounded**); one is blocked on a remaining atom (C10 on Workflow / State Machine). C11 became unblocked when Preference / Personalization grounded on 2026-05-29. Provenance also enriches three other compositions (C6, C7, C8) as an optional composing atom for chain-of-custody guarantees — those compositions remain unblocked without it, but gain emergent invariants when composed with it once it lands.
...
**Prerequisites:** Provenance *(atom #7 — `grounded` 2026-06-04)* + Actor Identity + Tamper Evidence + Retention Window + Audit Trail — **all grounded; C12 is now unblocked** (newly unblocked 2026-06-04). This entry is retained under "Blocked on remaining atoms" only as history of its former state; C12 is ready for authoring.
...
| C12 | Chain of Custody | Composition | Unblocked 2026-06-04 (Provenance grounded); not started | Provenance + Actor Identity + Tamper Evidence + Retention Window + Audit Trail — cross-domain reference case (pharma + legal evidence = same atoms) |
