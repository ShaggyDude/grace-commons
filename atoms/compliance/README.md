...
- [Selective Disclosure](./selective-disclosure.md) — append-only record of every disclosure of subject data: to whom, what scope, under what authority (consent, legal-hold, or regulatory), and when. The disclosure accountability primitive composing systems invoke after each data transfer to answer GDPR Art. 15(1)(c), HIPAA §164.528, and SEC Rule 17a-4 disclosure accounting requirements. `grounded` (last full rescan: 2026-05-13).
