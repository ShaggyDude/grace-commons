...
`partially resolved` — foundation passes complete (Pass 1, Pass 2, Pass 3) and one human refinement round complete (Refinement round 1). AI adversarial round pending before `grounded`.
