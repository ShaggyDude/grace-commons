...
- **Authentication** *(this is Credential — the `Authentication *(forthcoming)*` debt in [`atoms/actor-identity.md`](./actor-identity.md) is retired by this atom)* — see Composition notes in Actor Identity.
