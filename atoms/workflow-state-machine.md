...
- **[Permissions](./permissions.md)** — governs which actors may call `fire` for which workflow instances and which actions. This atom does not check permissions on `fire` calls; access control is a composing concern.
