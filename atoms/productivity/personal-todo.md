...
- **Recency-based duplicate prevention.** Compose with [Duplicate Prevention](../temporal/duplicate-prevention.md) if needed (see Composition notes).
